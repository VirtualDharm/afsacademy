...
function AboutPrograms() {
  return (
    <>
      {/* ============================================= */}
      {/* START: About Us Section (UPDATED) */}
      {/* ============================================= */}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative reveal animated">
              ...
              <div className="absolute -top-4 -right-4 w-16 h-16 rounded-full flex items-center justify-center bg-blippi-light border-2 border-blippi-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-dot text-blippi-primary animate-ball-bounce"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="1"></circle></svg>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ============================================= */}
      {/* START: Training Programs Section (UPDATED) */}
      {/* ============================================= */}
      <section className="py-20 bg-blippi-light">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center max-w-2xl mx-auto mb-12 reveal animated">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-blippi-dark">
              <span className="text-blippi-dark">Training Programs</span> Designed For
              Success
            </h2>
            ...
            <div className="reveal animated">
              <div className="bg-blippi-bg-white shadow-lg rounded-xl animated overflow-hidden card-hover h-full">
                ...
                <div className="p-6">
                  ...
                  <p className="text-blippi-grey mb-4">Focus Areas: Balance, posture, speed techniques, cornering, and race strategy.</p>
                  <div className="flex justify-between mb-4">
                    <div className="text-sm flex items-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star text-blippi-primary mr-1"><path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"></path></svg><span className="text-blippi-dark">Skating</span></div>
                    <div className="text-sm flex items-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-clock text-blippi-primary mr-1"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg><span className="text-blippi-dark">All Levels</span></div>
                  </div>
                </div>
              </div>
            </div>

            {/* Program Card 2: Taekwondo (FULLY UPDATED) */}
            <div className="reveal animated">
              <div className="bg-blippi-bg-white shadow-lg rounded-xl animated overflow-hidden card-hover h-full">
                <div className="aspect-[16/9] w-full">
                ...
                <div className="p-6">
                  ...
                  <p className="text-blippi-grey mb-4">Focus Areas: Kicking, sparring, Self-Defence, flexibility, and discipline.</p>
                  <div className="flex justify-between mb-4">
                    <div className="text-sm flex items-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star text-blippi-primary mr-1"><path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"></path></svg><span className="text-blippi-dark">Taekwondo</span></div>
                    <div className="text-sm flex items-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-clock text-blippi-primary mr-1"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg><span className="text-blippi-dark">Regular Sessions</span></div>
                  </div>
                </div>
              </div>
            </div>

            {/* Program Card 3: Gymnastics (FULLY UPDATED) */}
            <div className="reveal animated">
              <div className="bg-blippi-bg-white shadow-lg rounded-xl animated overflow-hidden card-hover h-full">
                <div className="aspect-[16/9] w-full">
                ...
                <div className="p-6">
                  ...
                  <p className="text-blippi-grey mb-4">Focus Areas: Strength, flexibility, coordination, and acrobatic movements.</p>
                  <div className="flex justify-between mb-4">
                    <div className="text-sm flex items-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star text-blippi-primary mr-1"><path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"></path></svg><span className="text-blippi-dark">Gymnastics</span></div>
                    <div className="text-sm flex items-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-clock text-blippi-primary mr-1"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg><span className="text-blippi-dark">Year-round Program</span></div>
                  </div>
                </div>
              </div>
            </div>
